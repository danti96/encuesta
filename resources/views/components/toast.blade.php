        ...
        <ul x-data="{
            ...
            <template x-for="(toast, index) in toasts" :key="toast.id">
                ...
                setTimeout(function() {
                    ...
                    <span
                        class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out sm:rounded-md sm:max-w-xs group font-bold"
                        :class="{
                            'p-4': !toast.html,
                            'p-0': toast.html,
                            'bg-slate-100 border border-green-600 text-gray-600': toast.type=='success',
                            'bg-slate-100 border border-blue-600 text-gray-600': toast.type=='info',
                            'bg-slate-100 border border-orange-600 text-gray-600': toast.type=='warning',
                            'bg-slate-100 border border-red-600 text-gray-600': toast.type=='danger',
                            'bg-gray-500 border-gray-900 text-white': toast.type=='default'
                        }">
                            ...
                            <div class="relative">
                                <div class="flex items-center"
                                    ...
                                    <p class="text-[13px] font-medium leading-none"
                                        :class="{ 'text-white': toast.type=='default', 'text-gray-800': toast.type!=='default' }"
